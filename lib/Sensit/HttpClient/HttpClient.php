...
namespace Sensit\HttpClient;

use Guzzle\Http\Client as GuzzleClient;
use Guzzle\Http\ClientInterface;
use Guzzle\Http\Message\RequestInterface;

use Sensit\HttpClient\AuthHandler;
use Sensit\HttpClient\ErrorHandler;
use Sensit\HttpClient\RequestHandler;
use Sensit\HttpClient\Response;
use Sensit\HttpClient\ResponseHandler;
